...
/// </summary>
sealed class ExcelRowEPPlus : ExcelRC
{
    #region 封装的行对象
    /// <summary>
    /// 获取封装的行对象，
    /// 本对象的功能就是通过它实现的
    /// </summary>
    private IEnumerable<ExcelRow> Row { get; }
    #endregion
    #region 是否隐藏
    ...
    public ExcelRowEPPlus(IExcelSheet sheet, IEnumerable<ExcelRow> row, int begin, int end)
