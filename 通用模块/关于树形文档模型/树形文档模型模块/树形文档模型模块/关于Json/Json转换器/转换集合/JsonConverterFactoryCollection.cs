...
/// </summary>
sealed class JsonConverterFactoryCollection : JsonConverterFactory
{
    #region 是否可执行转换
    ...
    public override JsonConverter? CreateConverter(Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        var converterType = typeof(JsonConverterCollection<,>).MakeGenericType(typeToConvert, elementType);
