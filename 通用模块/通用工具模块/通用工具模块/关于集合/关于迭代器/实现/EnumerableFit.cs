...
namespace System.Collections.Generic
{
    ...
    class EnumerableFit<Obj> : IEnumerableFit<Obj>
    {
        #region 用来枚举元素的迭代器
        #region 同步迭代器
        /// <summary>
        ...
        public EnumerableFit(object enumerable)
        {
            object _ = enumerable switch
            {
                ...
                _ => throw new ExceptionTypeUnlawful(enumerable, typeof(IEnumerable<Obj>), typeof(IAsyncEnumerable<Obj>))
            };
        }
        #endregion
    }
