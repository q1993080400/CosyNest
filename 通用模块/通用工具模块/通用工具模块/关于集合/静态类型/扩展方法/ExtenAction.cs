...
namespace System.Linq
{
    ...
    public static partial class ExtenIEnumerable
    {
        ...
        public static void AnyCheck(this IEnumerable collections, string? describe = null)
        {
            if (!collections.GetEnumerator().MoveNext())
        ...
        public static void Add<Obj>(this ICollection<Obj> collections, IEnumerable<Obj> objs)
            => objs.ForEach(x => collections.Add(x));
        ...
        */
        ...
        public static void RemoveWhere<Obj>(this ICollection<Obj> collections, Func<Obj, bool> @delegate)
        {
            ...
            void RemoveIList(IList<Obj> collections)
            {
                ...
                index.ForEach(x => collections.RemoveAt(x));
            }
            #endregion
