...
/// 可以视为一个长度单位
/// </summary>
sealed class UTLength : UT, IUTLength
{
    #region 返回单位的类型
    ...
    public UTLength(string name, Func<Num, Num> toMetric, Func<Num, Num> fromMetric, bool isStatic)
        : base(name, toMetric, fromMetric, isStatic)
    {
