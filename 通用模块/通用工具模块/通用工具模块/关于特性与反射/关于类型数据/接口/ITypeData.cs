...
namespace System.Reflection
{
    ...
    public interface ITypeData
    {
        ...
        EventInfo EventFind(string name, Type? declaringType = null);
        #endregion
        #endregion
        #region 关于字段
        #region 枚举所有字段
        ...
        FieldInfo FieldFind(string name, Type? declaringType = null);
        #endregion
        #endregion
        #region 关于属性
        #region 枚举所有属性
        ...
        PropertyInfo PropertyFind(string name, Type? declaringType = null);
        #endregion
        #endregion
        #region 关于索引器
        #region 枚举所有索引器
        ...
        PropertyInfo IndexingFind(IMethodSignature signature, Type? declaringType = null);
        #endregion
        #endregion
        #region 关于方法
        #region 枚举所有方法
        ...
        MethodInfo MethodFind(string name, IMethodSignature? signature = null, Type? declaringType = null);
        #endregion
        #endregion
    }
}
