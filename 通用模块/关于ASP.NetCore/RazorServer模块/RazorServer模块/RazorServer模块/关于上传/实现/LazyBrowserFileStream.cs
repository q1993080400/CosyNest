...
sealed class LazyBrowserFileStream(IBrowserFile file, long maxAllowedSize) : Stream, IStreamAdapter
{
    ...
    public async Task<Stream> SynchronousAdapter()
    {
        EnsureStreamIsOpen();
        return await UnderlyingStream.CopyToMemory();
    }
}