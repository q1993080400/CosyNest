...
namespace Microsoft.AspNetCore.Json
{
    ...
    /// </summary>
    class JsonOutputFormatterGeneral : TextOutputFormatter
    {
        #region 获取封装的序列化器
        /// <summary>
        ...
        protected override bool CanWriteType(Type type)
            => Serialization.CanSerialization(type);
        #endregion 
        #region 序列化对象
        public override Task WriteResponseBodyAsync(OutputFormatterWriteContext context, Encoding selectedEncoding)
        {
            var text = Serialization.SerializationUTF16(context.Object);
        ...
        public JsonOutputFormatterGeneral(ISerialization serialization)
        {
