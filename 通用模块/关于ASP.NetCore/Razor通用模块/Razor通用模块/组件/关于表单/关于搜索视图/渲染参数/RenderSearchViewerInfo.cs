...
public sealed record RenderSearchViewerInfo<Obj>
{
    #region 公开成员
    #region 生成数据筛选条件
    /// <summary>
    ...
    /// <inheritdoc cref="QueryBind{Property, Obj}.QueryBind(RenderSearchViewerInfo{Obj}, string, LogicalOperator)"/>
    ...
    /// <inheritdoc cref="SortBind{Property, Obj}.SortBind(RenderSearchViewerInfo{Obj}, string, Func{Property, bool?}, Func{bool?, Property})"/>
