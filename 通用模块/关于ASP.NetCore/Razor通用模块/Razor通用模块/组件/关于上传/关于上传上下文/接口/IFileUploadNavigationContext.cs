...
public interface IFileUploadNavigationContext
{
    ...
    /// <param name="uploadTaskInfo">这个上传组件所对应的上传任务</param>
    void RegisterUploadTaskInfo(string componentID, UploadTaskInfo uploadTaskInfo);
    #endregion
    #region 注销上传任务
    /// <summary>
    /// 注销上传任务，
    /// 它不会再与试图离开页面的事件相关联
    /// </summary>
    /// <inheritdoc cref="RegisterUploadTaskInfo(string, UploadTaskInfo)"/>
